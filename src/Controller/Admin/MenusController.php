 ...
 * @method \Cake\Datasource\ResultSetInterface<int, \App\Model\Entity\Menu> paginate(\Cake\Datasource\RepositoryInterface|\Cake\Datasource\QueryInterface|string|null $object = null, array $settings = [])
