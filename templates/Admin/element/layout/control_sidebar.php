...
<ul id="control-sidebar-menu" class="nav sidebar-menu flex-column" role="menu" data-accordion="false">
    <li class="nav-item">
        <a href="<?= $this->Url->build(['plugin' => false, 'controller' => 'Plugins', 'action' => 'index']) ?>" class="nav-link">
            <i class="nav-icon fa-solid fa-plug fa-fw"></i>
            <p>Plugins</p>
        </a>
    </li>
    <li class="nav-item">
        <a href="<?= $this->Url->build(['plugin' => false, 'controller' => 'Themes', 'action' => 'index']) ?>" class="nav-link">
    ...
    <li class="nav-item">
        <a href="<?= $this->Url->build(['plugin' => false, 'controller' => 'Roles', 'action' => 'index']) ?>" class="nav-link">
            <i class="nav-icon fa-solid fa-users fa-fw"></i>
            <p>Roles</p>
        </a>
    </li>
    <li class="nav-item">
        <a href="<?= $this->Url->build(['plugin' => false, 'controller' => 'Users', 'action' => 'index']) ?>" class="nav-link">
            <i class="nav-icon fa-solid fa-user-circle fa-fw"></i>
            <p>Users</p>
        </a>
    </li>
    <li class="nav-item">
        <a href="<?= $this->Url->build(['plugin' => false, 'controller' => 'Meta', 'action' => 'index']) ?>" class="nav-link">
            <i class="nav-icon fa-solid fa-tags fa-fw"></i>
            <p>Meta</p>
        </a>
    </li>
    <li class="nav-item">
        <a href="<?= $this->Url->build(['plugin' => false, 'controller' => 'Dashboard', 'action' => 'settings']) ?>" class="nav-link">
