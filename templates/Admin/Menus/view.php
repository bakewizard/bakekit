    ...
    <div class="card-header">
        ...
        <div class="card-tools">
            <?= $this->Html->link(
                ...
                ['controller' => 'MenuLinks', 'action' => 'add', $menu->id],
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <?= $this->Form->postLink(
                                ...
                                ['controller' => 'MenuLinks', 'action' => 'moveDown', $id],
                                ['escape' => false, 'class' => 'btn btn-outline-secondary'],
                            ) ?>
                            <?= $this->Form->postLink(
                                '<i class="fa-solid fa-arrow-up"></i>',
                                ['controller' => 'MenuLinks', 'action' => 'moveUp', $id],
                                ['escape' => false, 'class' => 'btn btn-outline-secondary'],
                            ) ?>
                        </td>
                        <td class="actions text-center">
                            <?= $this->Html->link(
                                ...
                                ['controller' => 'MenuLinks', 'action' => 'edit', $id],
                                ['escape' => false, 'class' => 'btn btn-outline-success'],
                            ) ?>
                            <?=
                            $this->Form->deleteLink(
                                '<i class="fa-solid fa-trash"></i>',
                                ['controller' => 'MenuLinks', 'action' => 'delete', $id],
                                [
                                    'block' => true,
                                    'escape' => false,
