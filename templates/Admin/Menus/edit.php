<div class="card card-success card-outline">
    <div class="card-header">
        <div class="card-title"><i class="fa-solid fa-edit me-2"></i><?= __('Edit Menu') ?></div>
    </div>
    <?= $this->Form->create($menu, ['align' => 'horizontal']) ?>
    <div class="card-body">
        <?= $this->Form->control('name'); ?>
        <?= $this->Form->control('description'); ?>
        <?= $this->Form->control('prefix', ['type' => 'radio', 'label' => __('Client'), 'inline' => true, 'options' => [['text' => 'Frontend', 'value' => 0], ['text' => 'Backend', 'value' => 1]]]); ?>
