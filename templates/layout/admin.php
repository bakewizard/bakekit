                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <div id="theme-switcher" class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="#" class="dropdown-item active" data-bs-theme="light"><i class="fa-solid fa-sun fa-fw me-2"></i>Light</a>
                            </li>
                            <li>
                                <a href="#" class="dropdown-item" data-bs-theme="dark"><i class="fa-solid fa-moon fa-fw me-2"></i>Dark</a>
                            </li>
                            <li>
                                <a href="#" class="dropdown-item" data-bs-theme="auto"><i class="fa-solid fa-circle-half-stroke fa-fw me-2"></i>Auto</a>
                            </li>
                        </ul>
                    </div>
                    <!--end::Theme switcher-->
                    ...
                    <li class="nav-item dropdown user-menu">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            ...
                            <li class="user-footer">
                                <?= $this->Html->link('<i class="fa-solid fa-user"></i> Profile', [
                                    'plugin' => false,
                                    'controller' => 'Users',
                                    'action' => 'edit',
                                    $this->Auth->get('id'),
                                ], ['class' => 'btn btn-outline-success btn-flat', 'escape' => false]) ?>
                                <?= $this->Html->link('<i class="fa-solid fa-sign-out-alt"></i> Sign out', [
                                    'plugin' => false,
                                    'controller' => 'Users',
                                    'action' => 'logout',
                                    $this->Auth->get('id'),
                                ], [
                                    'class' => 'btn btn-outline-danger btn-flat float-end',
                                    'escape' => false,
                                ]) ?>
                            </li>
                            <!--end::Menu Footer-->
        ...
        <footer class="app-footer">
            <div class="float-end d-none d-sm-inline">
                <a class="nav-link" href="<?= $this->Url->build([
                                                ...
                                                'action' => 'info',
                                            ], ['fullBase' => true]) ?>" target="_blank" title="PHP info">
